...
const { handelUserSignup ,handelUserLogin, handelGetLogin,handelAdmin,handelGetAdminLogin,handelValidatePasskey, handelChooseAdminOption, handelAdminViewId, handelUserDeleteAccount} = require('../controllers/user');
